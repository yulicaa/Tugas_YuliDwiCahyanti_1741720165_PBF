          ...
          <nav className="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div className="navbar-nav">
                ...
                <a className="nav-item nav-link active" style={{fontSize: "x-large", marginRight:"10px"}} href="/list">Your List</a>
  ...
  return (
    <div className="card-text">
      ...
      <div className="card-body">
        ...
        <br></br>
        <h2>Input Your ToDo List Bellow</h2>
        <div className="row">
          <CreateTodo />
          <div className="col-lg-10 offset-lg-2 col-md-10 col-sm-12 col-xs-12"></div>
          <Table />
        </div>
      </div>
    </div>
      ...
      <div className="card-body">
        <section className="container-1">
          ...
          <h4>Email Id: yulidcahya99@gmail.com</h4>
            <a id="mail" href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJvmZvlcCzmSHGvlKGGDhmxbfDfQVxlhqHkBghrmGXlppRcCsWsKKxWZqxsFCCmXZnbptTg"><img 
              id="mailmelogo" src={mailme} alt="mail me"/>Click Here To Send Mail</a>
          <h4>Contant Info: </h4>
            <a href="https://www.facebook.com/yulica.yulica.522">
              <i class="fab fa-facebook" style={{color:"antiquewhite"}}></i>
            </a>
            <a href="https://twitter.com/yeolaaa_" >
              <i class="fab fa-twitter" style={{color:"antiquewhite"}}></i>
            </a>
